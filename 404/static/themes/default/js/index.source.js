...
DOMReady(function () {
    ...
    if(document.getElementById("themeChange")){}
    if($("li.drop").el){
...
if(document.getElementById("imgArr")){
//顶部右上角广告图片随机显示
...
*/
;(function(){
    if(document.getElementById("s-hot")){
    window.Ylmf.toplist = function(topData){
        ...
        if(document.getElementsByClassName(".col-hotKeys").length>0){
...
(function(){
    var _themeShow = false,
        ...
        var settingSkinClassicsBlue =(function(){
            var _run =function(){
                if(document.getElementById("js_reOld")&&document.getElementById("js_feedback")){
